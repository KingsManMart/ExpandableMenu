package io.mahendra.expandablemenu;
...
public class ExpandableMenuView extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mCenterDrawable = getResources().getDrawable(menuDrawable);

        setDrawableBound();

        mCirclePaint = new Paint();
        mCirclePaint.setColor(getResources().getColor(colorRes));
        mCirclePaint.setStyle(Paint.Style.FILL);
        mSmallRadius = getResources().getDimensionPixelOffset(smallRadius);
        mBigRadius = getResources().getDimensionPixelOffset(bigRadius);
